...
myapp.controller("ContactController", ["$scope", "$resource", function($scope, $resource){
    ...
    $scope.add = function() {
        ...
        UIkit.modal.prompt("Name:", value, function(debtorName){

            newInvoice.Name = debtorName
